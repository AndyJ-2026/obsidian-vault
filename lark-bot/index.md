...
| 私聊对话 | 1v1 发消息 | 带上下文（最近 10 条，1 小时过期），仅限 owner |
| 约会议 | "帮我约个会" | 解析时间/参与者，发卡片到群+私信参会人 |
| 取消会议 | "取消那个会议" | 按关键词匹配删除 |
| 查人 | "查一下 xxx" | 搜索飞书通讯录 |
| 消息汇总 | "汇总一下" | 拉近 2 天 owner 相关消息，AI 总结 |
| 定向分析 | "帮我看看 XX 提了什么" | 按人/话题分析群消息 |
| 设提醒 | "明天中午提醒我写周报" | AI 解析时间，到时间自动发消息 |
| 创建任务 | "帮我建个任务 XXX" | 创建飞书任务，发卡片到群+私信指派人 |
...
| 工作日报 | 每天 20:00 自动 / 说"日报" | 汇总当天日历+消息，支持主动查看 |
